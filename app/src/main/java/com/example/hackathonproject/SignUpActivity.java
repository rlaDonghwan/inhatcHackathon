...
//            Intent intent = new Intent(SignIUpActivity.this, RegisterActivity.class);
...
//
//                // 메인 화면으로 이동
//                Intent intent = new Intent(SignIUpActivity.this, MainActivity.class);
//                intent.putExtra("userName", userName);
//                startActivity(intent);
//                finish();
//            } else {
//                // 로그인 실패 메시지 표시
//                Toast.makeText(SignIUpActivity.this, "로그인 실패. 다시 시도하세요.", Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
}
